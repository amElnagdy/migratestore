	...
	<h1><?php _e( 'Export Options', 'migratestore' ); ?></h1>
		...
		<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
			...
			<?php foreach ( $export_options as $option => $info ) : ?>
				<div class="ms-option">
					<input type="radio" id="<?php echo $option; ?>" name="migratestore_action" value="<?php echo $option; ?>">
			...
			<input class="button-primary" type="submit" value="<?php echo esc_attr__( 'Export Selected', 'migratestore' ); ?>">
		</form>
	</div>
</div>
